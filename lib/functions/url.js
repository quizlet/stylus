...
module.exports = function(options) {
  ...
  function fn(url){
    ...
    // END custom code for automatic retina images
    ...
    // Encode
    return new nodes.Literal('url("data:' + mime + ';base64,' + buf.toString('base64') + hash + '")'+(hdFound ? ' /*HD*/' : ''));
  };
